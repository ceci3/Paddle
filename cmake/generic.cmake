...
function(cc_library TARGET_NAME)
  ...
  if(cc_library_SRCS)
    ...
    if(cc_library_DEPS)
      ...
      ###target_link_libraries(${TARGET_NAME} libgfpq.so)
      target_link_libraries(${TARGET_NAME} libgfpq_gpu.so)
      #target_link_libraries(${TARGET_NAME} ~/work/test/HiSVP_PC_V1.2.2.2/tools/gfpq_lib/GFPQLibs_20190822_CUDA10/lib/libgfpq.so)
...
function(nv_library TARGET_NAME)
  if (WITH_GPU)
    ...
    if(nv_library_SRCS)
      ...
      target_link_libraries(${TARGET_NAME} libgfpq_gpu.so)
      #target_link_libraries(${TARGET_NAME} ~/work/test/HiSVP_PC_V1.2.2.2/tools/gfpq_lib/GFPQLibs_20190822_CUDA10/lib/libgfpq_gpu.so)
